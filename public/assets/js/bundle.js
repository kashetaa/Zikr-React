...
*/
        ...
        var DirectionReveal = function DirectionReveal() {
          var _ref =
            ...
            selector =
              _ref$selector === undefined ? '.direction-reveal' : _ref$selector,
            _ref$itemSelector = _ref.itemSelector,
            itemSelector =
              _ref$itemSelector === undefined
                ? '.direction-reveal__card'
                : _ref$itemSelector,
            _ref$animationName = _ref.animationName,
            animationName =
              _ref$animationName === undefined ? 'swing' : _ref$animationName,
            _ref$enableTouch = _ref.enableTouch,
            enableTouch =
              _ref$enableTouch === undefined ? true : _ref$enableTouch,
            _ref$touchThreshold = _ref.touchThreshold,
            touchThreshold =
              _ref$touchThreshold === undefined ? 250 : _ref$touchThreshold;
          ...
          var addClass = function addClass(e, state) {
            ...
            var filteredCssClasses = currentCssClasses
            ...
            currentItem.classList.add(
              animationName + '--' + state + '-' + directionString
            );
          };
              ...
              if (enableTouch) {
                ...
                item.addEventListener('touchend', function (e) {
                  ...
                  if (
                    ...
                    !item.className.includes(animationName + '--in')
                  ) {
                    e.preventDefault();
          ...
          var addEventListenerMulti = function addEventListenerMulti(
            element,
            events,
            fn
          ) {
          ...
          var resetVisible = function resetVisible(e, items, callback) {
            items.forEach(function (item) {
              ...
              if (
                currentCssClasses.includes(animationName + '--in') &&
