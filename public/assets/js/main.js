(function ($) {
  ...
  $('.banner_slider').on('translate.owl.carousel', function () {
    $('.banner_cell .banner_total p')
      .removeClass('slideInLeft animated')
      .hide();
    $('.banner_cell .banner_total h1')
      .removeClass('slideInRight animated')
      .hide();
    $('.banner_cell .banner_total .banner_btn .btn_one')
      .removeClass('slideInLeft animated')
      .hide();
    $('.banner_cell .banner_total .banner_btn .btn_two')
      .removeClass('slideInRight animated')
      .hide();
    $('.bnr_content').removeClass('slideInDown animated').hide();
  });
  $('.banner_slider').on('translated.owl.carousel', function () {
    $('.owl-item.active .banner_cell .banner_total p')
      .addClass('slideInLeft animated')
      .show();
    $('.owl-item.active .banner_cell .banner_total h1')
      .addClass('slideInRight animated')
      .show();
    $('.owl-item.active .banner_cell .banner_total .banner_btn .btn_one')
      .addClass('slideInLeft animated')
      .show();
    $('.owl-item.active .banner_cell .banner_total .banner_btn .btn_two')
      .addClass('slideInRight animated')
      .show();
    $('.bnr_content').addClass('slideInDown animated').show();
  });
