  ...
  (b = (function () {
    function c(c, d) {
      ...
      if (
        ((e.defaults = {
          ...
          asNavFor: null,
          prevArrow:
            '<button type="button" data-role="none" class="slick-btn slick-prev bgbg" aria-label="previous"><i class="fa fa-angle-left"></i></button>',
          nextArrow:
            '<button type="button" data-role="none" class="slick-btn slick-next" aria-label="next"><i class="fa fa-angle-right"></i></button>',
          autoplay: !1,
          autoplaySpeed: 3e3,
          centerMode: !1,
          centerPadding: '50px',
    ...
    (b.prototype.cleanUpEvents = function () {
      ...
      b.options.dots === !0 &&
        ...
        b.options.dots === !0 &&
          ...
          a('li', b.$dots)
            .off('mouseenter.slick', b.setPaused.bind(b, !0))
            .off('mouseleave.slick', b.setPaused.bind(b, !1)),
        b.options.arrows === !0 &&
          b.slideCount > b.options.slidesToShow &&
    ...
    (b.prototype.initDotEvents = function () {
      ...
      b.options.dots === !0 &&
        ...
        b.options.dots === !0 &&
          ...
          b.options.autoplay === !0 &&
          a('li', b.$dots)
            .on('mouseenter.slick', b.setPaused.bind(b, !0))
            .on('mouseleave.slick', b.setPaused.bind(b, !1));
    }),
    (b.prototype.initializeEvents = function () {
      ...
      b.initArrowEvents(),
        ...
        b.options.autoplay === !0 &&
          a(document).on(b.visibilityChange, b.visibility.bind(b)),
