            ...
            : (l.removeEvents(),
              ...
              'zoom' === o
                ? (n.fancybox.stop(i),
                  ...
                  n.fancybox.animate(f.$content, c, a, p),
                  !0)
                : (o && a
                    ? t === !0
                      ? setTimeout(p, a)
      ...
      updateControls: function (t) {
        ...
        n.$slide.trigger('refresh'),
          ...
          'image' === n.type
            ...
            : i.find('[data-fancybox-download]').hide();
      },
      ...
      (n.fancybox = {
        ...
        animate: function (t, e, a, i, s) {
          n.isFunction(a) && ((i = a), (a = null)),
            ...
            t.on(d || 'transitionend', function (a) {
              (!a ||
                !a.originalEvent ||
    ...
    e.extend(n.prototype, {
      ...
      init: function () {
        var t = this,
          ...
          n = e.group[0],
          o = e.group[1];
        (t.opts = e.group[e.currIndex].opts.thumbs),
      ...
      create: function () {
        var t,
          ...
          a = o.instance,
          i = o.opts.parentEl;
        (o.$grid = e('<div class="fancybox-thumbs"></div>').appendTo(
      ...
      focus: function (t) {
        ...
        this.instance.current &&
          ...
          n.top < 0 || n.top > o.height() - e.outerHeight()
            ...
            : (n.left < 0 || n.left > o.width() - e.outerWidth()) &&
              o.stop().animate({ scrollLeft: o.scrollLeft() + n.left }, t));
      },
      update: function () {
    ...
    e.extend(!0, e.fancybox.defaults, {
      ...
      e(t).on('click', '[data-fancybox-share]', function () {
        var t,
          n = e.fancybox.getInstance();
        n &&
          ((t = n.current.opts.share.tpl.replace(
            /\{\{src\}\}/g,
            encodeURIComponent(
              n.current.opts.hash === !1 ? n.current.src : window.location
            )
          )),
          n.$caption &&
            (t = t.replace(
